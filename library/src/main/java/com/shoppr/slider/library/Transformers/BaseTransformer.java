package com.shoppr.slider.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.shoppr.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.shoppr.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.shoppr.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
