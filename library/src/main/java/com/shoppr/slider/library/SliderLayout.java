package com.shoppr.slider.library;
...
import com.shoppr.slider.library.Animations.BaseAnimationInterface;
import com.shoppr.slider.library.Indicators.PagerIndicator;
import com.shoppr.slider.library.SliderTypes.BaseSliderView;
import com.shoppr.slider.library.Transformers.AccordionTransformer;
import com.shoppr.slider.library.Transformers.BackgroundToForegroundTransformer;
import com.shoppr.slider.library.Transformers.BaseTransformer;
import com.shoppr.slider.library.Transformers.CubeInTransformer;
import com.shoppr.slider.library.Transformers.DefaultTransformer;
import com.shoppr.slider.library.Transformers.DepthPageTransformer;
import com.shoppr.slider.library.Transformers.FadeTransformer;
import com.shoppr.slider.library.Transformers.FlipHorizontalTransformer;
import com.shoppr.slider.library.Transformers.FlipPageViewTransformer;
import com.shoppr.slider.library.Transformers.ForegroundToBackgroundTransformer;
import com.shoppr.slider.library.Transformers.RotateDownTransformer;
import com.shoppr.slider.library.Transformers.RotateUpTransformer;
import com.shoppr.slider.library.Transformers.StackTransformer;
import com.shoppr.slider.library.Transformers.TabletTransformer;
import com.shoppr.slider.library.Transformers.ZoomInTransformer;
import com.shoppr.slider.library.Transformers.ZoomOutSlideTransformer;
import com.shoppr.slider.library.Transformers.ZoomOutTransformer;
import com.shoppr.slider.library.Tricks.FixedSpeedScroller;
import com.shoppr.slider.library.Tricks.InfinitePagerAdapter;
import com.shoppr.slider.library.Tricks.InfiniteViewPager;
import com.shoppr.slider.library.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link com.shoppr.slider.library.Indicators.PagerIndicator}
 * and {@link com.shoppr.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link com.shoppr.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link com.shoppr.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.shoppr.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.shoppr.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.shoppr.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.shoppr.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.shoppr.slider.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.shoppr.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.shoppr.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.shoppr.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mViewPager = (InfiniteViewPager)findViewById(R.id.shoppr_slider_viewpager);
     ...
     * {@link com.shoppr.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.shoppr.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.shoppr.slider.library.Indicators.PagerIndicator} instance.
